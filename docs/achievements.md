...
| ![rm -rf / shaped sticker](https://www.unixstickers.com/image/cache/data/stickers/shell/rm--rf.sh-340x340.png) | `rm -rf /` shaped sticker | Weel 3 challenge: [make some food](https://raw.githubusercontent.com/jennydaman/twlinux/master/student_resources/week3_challenge/recipe.gpg) | **3/5** |        |
